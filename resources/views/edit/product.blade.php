                            ...
                            <form method="POST" action="{{ route('request.quote') }}">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-12">
                                            <button for="files" class="btn btn-light add-image" onclick="selectImages()">
                                            ...
                                            <input type="file" id="files" name="files" style="visibility:hidden !important;" multiple>
                                        </div>
                                    </div>
                                </div>
